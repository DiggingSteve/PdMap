(function () {
    ...
    maptalks.HaloLayer.registerRenderer('canvas', maptalks.renderer.Canvas.extend({
        ...
        _drawHalos: function (matrix) {
            ...
            this._currentHalos.forEach(function (halo) {
                ...
                var key = halo['cacheKey'];
                var cache = this._haloCache[key];
                if (cache && op > 0) {
        ...
        _prepareHaloCache: function () {
            ...
            for (var p in this._haloSymbols) {
                if (this._haloSymbols.hasOwnProperty(p)) {
                    ...
                    var canvas = this._createHaloImage(symbol);
                    this._haloCache[p] = canvas;
                }
            }
        },

        _createHaloImage: function (symbol) {
            var map =  this.getMap(),
                size = this._maxSize;
