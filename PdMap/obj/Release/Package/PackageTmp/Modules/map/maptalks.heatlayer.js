...
var maptalks = nodeEnv ? require('maptalks') : window.maptalks;

var HeatLayer = maptalks.HeatLayer = maptalks.Layer.extend({
 ...
 */
HeatLayer.prototype.toJSON=function(options) {
    if (!options) {
        options = {};
    }
    var profile = {
 ...
 * @function
 */
HeatLayer.fromJSON=function(layerJSON) {
...
HeatLayer.registerRenderer('canvas', maptalks.renderer.Canvas.extend({
    ...
    onResize: function () {
        ...
        if(this._heater && this._heater.resize) this._heater.resize(); // modified 2017-03-28
    },
...
if (nodeEnv) {
    exports = module.exports = HeatLayer;
}
})();